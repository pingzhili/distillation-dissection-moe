...
accelerate launch --num_processes=8 scripts/finetune.py --base_model_name="allenai/OLMoE-1B-7B-0125" \
  --dataset_name="Phando/sft-dataset-from-moonlight" --output_dir="outputs/olmoe-1b-7b-0125-sft"