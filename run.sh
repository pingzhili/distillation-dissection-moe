...
accelerate launch --config_file configs/zero-2.yaml scripts/finetune.py \
  --base_model_name="deepseek-ai/DeepSeek-V2-Lite" --dataset_name="Phando/sft-dataset-from-moonlight" \
  --output_dir="outputs/deepseek-v2-lite-sft" --batch_size_per_device=1 --gradient_accumulation_steps=32 \
